...
fa.setCarrier(10e6+5109.6333e6)
...
class fftAnalyzerR2:
    ...
    def __init__(self,
        ...
        if self.roach2 != None:
            ...
            self.mainFW = ROACH_DIR+'/projcts/bestBitFiles/qdrdac_2016_Jul_11_1331.bof'

            #fw for testing flux ramp demod on roach
            #self.mainFW = ROACH_DIR+'/projcts/bestBitFiles/qdrdac_2016_Jul_25_1611.bof'
